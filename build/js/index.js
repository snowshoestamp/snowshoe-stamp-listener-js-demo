...
var axiosConfig = {
  ...
  headers: {
    post: {
      'SnowShoe-Api-Key': apiKeyInput.value
    }
  }
};
...
var stampListener = new _snowshoe_stamp_listener__WEBPACK_IMPORTED_MODULE_0__["default"]({
  stampScreenElementId: 'stamp-screen',
  preventScrolling: true,
  preventZooming: true
}); // Specify a function to be called when a stamp event occurs.

stampListener.listen(function (stampDataPoints, reEnableStampScreen) {
  axiosConfig.headers.post['SnowShoe-Api-Key'] = apiKeyInput.value;
  axios__WEBPACK_IMPORTED_MODULE_1___default().post('/v3/stamp', {
    data: stampDataPoints
  }, axiosConfig).then(function (response) {
    notyf.success("Successfully verified stamp: ".concat(response.data.stamp.serial));
  })["catch"](function (error) {
    var _error$response;

    var httpStatusCode = (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status;

    if (httpStatusCode === 401) {
      notyf.error("Verification failed... the API key is most likely incorrect.");
    } else if (httpStatusCode === 400) {
      notyf.error("The stamp is most likely not registered... ".concat(error.response.data.error.message));
    } else {
      notyf.error("Some unlikely issue (like a network connection failure) has occurred. Is your API endpoint correct? ".concat(error));
    }
  })["finally"](function () {
    reEnableStampScreen();
  });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksnowshoe_stamp_listener_demo"] = self["webpackChunksnowshoe_stamp_listener_demo"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["build/css/index"], function() { return __webpack_require__("./src/index.js"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["build/css/index"], function() { return __webpack_require__("./src/index.scss"); })
